...
The newest piece is the one I'd have wanted on day one. When Claunchpad finishes setting up your project, it offers to install a small handful of tools that genuinely punch above their weight (your choice: take all of them, pick a few, or skip):
